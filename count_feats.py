...
train_data = pd.read_csv(train_path, sep='\t', header=None, names=cols, encoding='utf-16')
test_data = pd.read_csv(test_path, sep='\t', header=None, names=cols, encoding='utf-16')
